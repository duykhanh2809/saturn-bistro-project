...
questionAll.forEach((ele, ind)=>{
    ele.addEventListener("click", (event)=>{
        ...
        if (answerAll[ind].classList.contains("faq__answer-active")) icon.style.transform = "rotate(0)";
        else icon.style.transform = "rotate(45deg)";
...
//# sourceMappingURL=main-wine.1c974c2f.js.map
